...
const AiIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 2a10 10 0 0 0-10 10c0 3.53 1.94 6.58 4.7 8.29" />
        <path d="M12 22a10 10 0 0 0 10-10c0-3.53-1.94-6.58-4.7-8.29" />
        <path d="m14.5 7.5-.01 0" />
        <path d="m9.5 7.5-.01 0" />
    </svg>
);
...
const WordCounter: React.FC = () => {
  ...
  const handleGoogleAiStudioToggle = (checked: boolean) => {
    if (checked) {
      window.open('https://aistudio.google.com/prompts/new_chat?model=gemini-2.5-pro', '_blank', 'noopener,noreferrer');
      setTimeout(() => setShowGoogleAiStudio(false), 200);
    }
  };
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard 
            ...
            value={bonusCount}
            icon={<StarIcon />}
            colorClasses="bg-amber-100 text-amber-900"
          />
          <StatCard 
          ...
          <StatCard 
            ...
            value={melbetCount}
            icon={<MelbetIcon />}
            colorClasses="bg-cyan-100 text-cyan-900"
          />
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <ToolCard id="google-ai-studio-tool" label="Google AI Studio" icon={<AiIcon className="w-5 h-5"/>} checked={showGoogleAiStudio} onChange={handleGoogleAiStudioToggle} />
          </div>
        </div>
