      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <ToolCard id="yt-transcript-2-tool" label="YT Transcript 2" icon={<YoutubeIcon className="w-5 h-5"/>} checked={showYtTranscript2} onChange={setShowYtTranscript2} />
               ...
               {showYtTranscript && (
                ...
                {showYtTranscript2 && (
                    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-8 h-8 flex items-center justify-center bg-red-100 rounded-full text-red-600"><YoutubeIcon className="w-5 h-5" /></div>
                            <h3 className="text-lg font-bold text-slate-800">YT Transcript 2 (Noteey)</h3>
                        </div>
                        <p className="text-sm text-slate-600 mb-4">
                            The website <a href="https://www.noteey.com/youtube-transcript-generator" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline font-medium">noteey.com</a> is embedded below for your convenience.
                        </p>
                        <div className="border border-slate-300 rounded-lg overflow-hidden">
                            <iframe
                                src="https://www.noteey.com/youtube-transcript-generator"
                                title="Noteey YouTube Transcript Generator"
                                className="w-full h-[500px] md:h-[600px] border-0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen
                            ></iframe>
